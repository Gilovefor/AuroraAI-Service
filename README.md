# AuroraAI-Service
**在Http服务器的基础上搭建了AI服务，可以做包括日常对话，工具调用，图像识别等工作**
*** 
...
* 多模态架构，支持文本、图像、语音等多种输入输出类型的AI模型，支持图片Base64编码传输，语音合成与识别功能
* MCP工具编排，包含获取时间，天气等工具，通过标准化接口降低模块耦合，便于后续扩展新工具
* RAG检索增强，基于外部知识库实现，结合外部知识检索结果提升回答准确性与时效性
